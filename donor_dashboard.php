...
<script src="js/bootstrap-slider.js"></script>
							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									<li class="nav-item active">
										<a class="nav-link" onclick="donate();" href="#">Donate</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" onclick="view();" href="#">View</a>
									</li>
									<li class="nav-item ">
										<a class="nav-link" onclick="volunteer();">Volunteer</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" onclick="donorprofile();" href="#">My Profile</a>
									</li>
									<li class="nav-item">
	...
	<div class="col-md-12" id="dashboard_body">
	</div>
